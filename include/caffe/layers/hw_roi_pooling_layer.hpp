...
namespace caffe {
	...
	*/
	...
	class HWROIPoolingLayer : public Layer<Dtype> {
	public:
		explicit HWROIPoolingLayer(const LayerParameter& param)
			: Layer<Dtype>(param) {}
		...
		virtual inline const char* type() const { return "HWROIPooling"; }
