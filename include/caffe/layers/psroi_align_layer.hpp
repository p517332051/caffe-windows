#ifndef CAFFE_PSROI_ALIGN_LAYER_HPP_
#define CAFFE_PSROI_ALIGN_LAYER_HPP_
...
class PSROIAlignLayer : public Layer<Dtype> {
 public:
	 explicit PSROIAlignLayer(const LayerParameter& param)
    : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "PSROIAlign"; }
